...
class WelcomeScreen(QWidget):
    def __init__(self):
        ...
        title = QLabel("Installer Patch ITA per Yakuza 5 Remastered")
...
class InstallScreen(QWidget):
    def __init__(self):
        ...
        path_label = QLabel("Installa la patch nella cartella principale di Yakuza 5 Remastered:")
        path_label.setObjectName("SubtitleLabel")
        
        self.path_input = QLineEdit()
        self.path_input.setPlaceholderText("Es: C:/.../Steam/steamapps/common/Yakuza 5")
...
class InstallerWizard(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle(f"Installer Patch Beta ITA Yakuza 5 Remastered ({VERSIONE})")
